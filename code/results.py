...
class BayesResults:
    ...
    def plot_regression(self):
        ...
        ntick = df.shape[1]
        plt.xticks(ticks=np.arange(0,ntick)+0.5,labels=list(df.columns), rotation=90);
        plt.yticks(ticks=np.arange(0,ntick)+0.5,labels=list(df.columns), rotation=0);
